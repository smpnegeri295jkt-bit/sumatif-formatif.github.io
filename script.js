document.addEventListener('DOMContentLoaded', () => {
    ...
    const teacherList = ["WASIYEM,M.Pd", "FIRLI RISA JUMRIANI,S.Pd", "DIYAN NUR EKAWATI,S.Pd", "IQBAL TAWAKAL,S.Pd", "ABRIYANTO GUNAWAN,S.KOM", "FITRIANA, MM", "RUSBIYANTO,S.Pd", "SITI SUNARSIH S.Pd", "SELVIA DEWI SETIYANI,S.Pd", "MOHAMAD ARIFIN JUHRI, S.Pd", "NUSRIANTI TODING PADANG, S.Th"];
    const tugasTambahanList = ["-", "Kepala Sekolah", "Wakil Kasek Bid Kurikulum", "Wakil Kasek Bid Kesiswaan", "Wakil Kasek Bid Sarpras", "Wali kelas", "Guru Piket", "Pembina OSIS", "Kepala Perpustakaan"];
    const classList = ['7A', '7B', '7C', '7D', '7E', '7F', '7G'];
